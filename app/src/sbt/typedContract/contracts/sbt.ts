...
import ABI from '../../artifacts/sbt.json';
import QueryMethods from '../query/sbt';
import BuildExtrinsicMethods from '../build-extrinsic/sbt';
import TxSignAndSendMethods from '../tx-sign-and-send/sbt';
import MixedMethods from '../mixed-methods/sbt';
import EventsClass from '../events/sbt';
