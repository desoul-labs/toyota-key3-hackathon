...
export default class Methods {
	...
	*/
	"hasToken" (
		...
		return buildSubmittableExtrinsic( this.__apiPromise, this.__nativeContract, "hasToken", [], __options);
	}
	...
	*/
	"mintToken" (
		...
		return buildSubmittableExtrinsic( this.__apiPromise, this.__nativeContract, "mintToken", [], __options);
	}
	...
	*/
	"totalOwners" (
		...
		return buildSubmittableExtrinsic( this.__apiPromise, this.__nativeContract, "totalOwners", [], __options);
	}
