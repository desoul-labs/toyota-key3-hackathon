...
import ABI from '../../artifacts/task_manager.json';
import QueryMethods from '../query/task_manager';
import BuildExtrinsicMethods from '../build-extrinsic/task_manager';
import TxSignAndSendMethods from '../tx-sign-and-send/task_manager';
import MixedMethods from '../mixed-methods/task_manager';
import EventsClass from '../events/task_manager';
