...
export default class Methods {
	...
	*/
	"getDeadline" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "getDeadline", (events: EventRecord) => {
			return decodeEvents(events, this.__nativeContract, "task_manager");
		}, [id], __options);
	}
	...
	*/
	"isCompleted" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "isCompleted", (events: EventRecord) => {
			return decodeEvents(events, this.__nativeContract, "task_manager");
		}, [id], __options);
	}
	...
	*/
	"getScore" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "getScore", (events: EventRecord) => {
			return decodeEvents(events, this.__nativeContract, "task_manager");
		}, [account], __options);
	}
	...
	*/
	"getTotalScore" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "getTotalScore", (events: EventRecord) => {
			return decodeEvents(events, this.__nativeContract, "task_manager");
		}, [], __options);
	}
	...
	*/
	"isEvaluated" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "isEvaluated", (events: EventRecord) => {
			return decodeEvents(events, this.__nativeContract, "task_manager");
